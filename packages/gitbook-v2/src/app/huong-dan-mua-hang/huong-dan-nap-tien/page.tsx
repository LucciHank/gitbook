...
export default function HuongDanNapTienPage() {
  ...
  // SEO metadata
  const pageTitle = "Hướng dẫn nạp tiền tại TomOi.vn | Chuyển khoản & Thẻ cào";
  const pageDescription = "Hướng dẫn chi tiết cách nạp tiền vào tài khoản TomOi.vn bằng chuyển khoản ngân hàng OCB hoặc thẻ cào Viettel. Quy trình đơn giản, nhanh chóng và an toàn.";
            ...
            <div className={styles.contentCard}>
              ...
              <div className={styles.methodsContainer}>
                <div className={styles.method}>
                  ...
                  <div className={styles.methodBadge}>Nhanh chóng</div>
                </div>
                <div className={styles.method}>
                  <div className={styles.methodIcon}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div className={styles.methodBadge}>Tiện lợi</div>
                </div>
              </div>
              ...
              <section className={styles.section} id="chuyen-khoan-ngan-hang">
                    ...
                    <div className={styles.bankInfoBox}>
                      ...
                      <div className={styles.bankInfoRow}>
                        ...
                        <div className={styles.bankInfoValue}>
                          <span className={styles.accountNumber}>0562147786</span>
                          <button className={styles.copyButton} title="Sao chép số tài khoản" onClick={() => copyToClipboard("0562147786")}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill={copySuccess ? "green" : "currentColor"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      <div className={styles.bankInfoRow}>
                        ...
                        <div className={styles.bankInfoValue}>
                          <span className={styles.transferContent}>CK [Tên đăng nhập của bạn]</span>
                          <div className={styles.importantNote}>Quan trọng: Nhập chính xác nội dung này</div>
                        </div>
                      </div>
                    </div>
                ...
                <div className={styles.alertBox}>
                  ...
                  <div className={styles.alertContent}>
                    <h4 className={styles.alertTitle}>Lưu ý quan trọng</h4>
                    <ul>
                      ...
                      <li><strong>Bắt buộc phải ghi chính xác nội dung chuyển khoản</strong> (CK [Tên đăng nhập]), nếu sai, hệ thống sẽ không thể tự động cộng tiền vào tài khoản của bạn. Trong trường hợp sai sót này, bạn phải liên hệ hỗ trợ khách hàng để được xử lý thủ công.</li>
                    </ul>
                  </div>
                </div>
              </section>
